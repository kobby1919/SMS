                ...
                >
                  <div className="flex items-start justify-between gap-3">
                    <div className="min-w-0">
                      <p className="truncate text-sm font-black text-edujay-ink">
                        {cls.name}
                      </p>
                      <p className="mt-0.5 text-xs font-semibold text-gray-500">
                        {cls.studentCount} student{cls.studentCount === 1 ? "" : "s"} · Grade {cls.gradeLevel}
                      </p>
                    </div>
                    <span className="shrink-0 rounded-lg bg-slate-950 px-2 py-1 text-[10px] font-black uppercase text-white">
                      My Class
                    </span>
                  </div>
                  <div className="mt-3">
