  ...
  return (
    <div className="flex-1 m-4 mt-0 flex flex-col gap-4">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        {[
          { label: "Total Teachers", value: teachersData.length, icon: <Users size={16} />, color: "bg-indigo-50 text-indigo-600" },
          { label: "Subjects Taught", value: 6, icon: <BookOpen size={16} />, color: "bg-amber-50 text-amber-600" },
          { label: "Active Classes", value: 12, icon: <Users size={16} />, color: "bg-emerald-50 text-emerald-600" },
          { label: "New This Month", value: 2, icon: <Plus size={16} />, color: "bg-violet-50 text-violet-600" },
        ].map((stat) => (
