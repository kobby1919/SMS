...
import { formatGHS, BILL_STATUS_STYLES } from "@/src/lib/actions/financeActions";
...
const BursarPage = async () => {
  ...
  // ── Total outstanding (sum of all bill balances that are not paid/waived) ─
  ...
  // ── Bills needing attention (unpaid with highest balances) ────────────────
  ...
  // ── Draft fee structures (remind bursar to publish) ───────────────────────
