...
export const calendarEvents: CalendarEvent[] = [
  ...
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(2026, 3, 7, 11, 0),
    end: new Date(2026, 3, 7, 11, 45),
  },
  {
    title: "Chemistry",
    allDay: false,
  ...
  },
  {
    ...
    end: new Date(2026, 3, 10, 9, 45),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2026, 3, 10, 10, 0),
    end: new Date(2026, 3, 10, 10, 45),
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(2026, 3, 10, 11, 0),
    end: new Date(2026, 3, 10, 11, 45),
  },
  {
    title: "History",
    allDay: false,
    start: new Date(2026, 3, 10, 14, 0),
    end: new Date(2026, 3, 10, 14, 45),
  },
  {
    title: "Math",
    allDay: false,
    start: new Date(2026, 3, 11, 8, 0),
    end: new Date(2026, 3, 11, 8, 45),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(2026, 3, 11, 9, 0),
    end: new Date(2026, 3, 11, 9, 45),
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(2026, 3, 11, 11, 0),
    end: new Date(2026, 3, 11, 11, 45),
  },
  {
    title: "Chemistry",
    allDay: false,
    start: new Date(2026, 3, 11, 13, 0),
    end: new Date(2026, 3, 11, 13, 45),
  },
  {
    title: "History",
    allDay: false,
    start: new Date(2026, 3, 11, 14, 0),
    end: new Date(2026, 3, 11, 14, 45),
  },
];