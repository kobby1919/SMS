...
import { acceptTeacherInviteAction } from "@/src/lib/actions/teacherInviteActions";

export default function TeacherInviteAcceptButton({ token }: { token: string }) {
  ...
  return (
    <div className="mt-8">
      ...
      >
        ...
        {isPending ? "Connecting account..." : "Connect my teacher account"}
      </button>
